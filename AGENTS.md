...
This repository hosts `sync-ai-md`, a Python CLI tool that keeps three markdown
files—`AGENTS.md`, `CLAUDE.md`, and `GEMINI.md`—synchronized. The tool copies
the body of the most recently updated file to the others while preserving each
file’s header line and exits with status codes that describe what happened (no
files, files created, or files updated).
